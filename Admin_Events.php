  ...
  <form class="form-horizontal" method="post">
    <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input id="textinput" name="eventName" type="text" placeholder="" class="form-control input-ml" required="">
        ...
        <!-- Text input-->
        <div class="form-group">
            <label class="col-md-4 control-label" for="venueName">Description</label>
            <div class="col-md-6">
                <input style="height:50px" id="venueName" name="description" type="text" placeholder="" class="form-control input-md">
        ...
        <!-- Appended Input-->
        <div class="form-group">
            <label class="col-md-4 control-label" for="eventDate">Start Date</label>
            <div class="col-md-4">
                <div class="input-group">
                    <input id="datetime" name="startdatetime" type="datetime-local" class="form-control" required="">
                </div>
        ...
        <!-- Appended Input-->
        <div class="form-group">
            <label class="col-md-4 control-label" for="eventDate">End Date</label>
            <div class="col-md-4">
                <div class="input-group">
                    <input id="datetime" name="enddatetime" type="datetime-local" class="form-control" required="">
                </div>
        ...
        <!-- Text input-->
        <div class="form-group">
            <label class="col-md-4 control-label" for="venueName">Location</label>
            <div class="col-md-6">
                <input id="venueName" name="location" type="text" placeholder="" class="form-control input-md">
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                <button id="submitButton" onClick="addEvent(eventName.value,venue.value,startdatetime.value,enddatetime.value,location.value)"name="submitButton" class="btn btn-primary">Create</button>
            </div>
        </div>
                ...
                <div id="myleftnav" class="leftnav">
                        ...
                        <br>
                        <br>
                    <p><a href="Admin_Reports.html">Reports<i class="material-icons">priority_high</i></a></p>
                ...
                <div id="myrightnav" class="rightnav">
                        <p>Events <a href="Admin_Events.php"><i class="material-icons">add_circle_outline</i></a></p>
	...
	<script>
	function addEvent(eventName,description,startdatetime,enddatetime,location){
		if(eventName=="" && description==""){
			console.log("No user");
		}else
			var mongo="http://127.0.0.1:8080/db/events";
			var restBody = '{"event_name":"' + eventName + '", "description":"' + description + '", "startdatetime":"' + startdatetime + '","enddatetime":"' + enddatetime + '", "location":"' + location + '"}';
